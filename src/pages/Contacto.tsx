                  ...
                  <Card className="p-6 border-2 hover:border-secondary/50 transition-colors">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+258853135136" className="text-sm text-primary hover:underline block">
                          +258 853 135 136
                        </a>
                        <a href="tel:+258868499221" className="text-sm text-primary hover:underline block">
                          +258 868 499 221
                        </a>
                      </div>
                    </div>
