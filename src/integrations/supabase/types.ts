  ...
  public: {
    Tables: {
      analises_ia: {
        ...
        Relationships: [
          {
            foreignKeyName: "analises_ia_farmacia_id_fkey"
            columns: ["farmacia_id"]
            isOneToOne: false
      ...
      clientes: {
        Row: {
          ...
          localizacao_ultima: string | null
      ...
      consultas: {
        Row: {
          ...
          id: string
          latitude: number | null
          localizacao_informada: string | null
          longitude: number | null
      ...
      estoque: {
        ...
        Relationships: [
          {
            foreignKeyName: "estoque_farmacia_id_fkey"
            columns: ["farmacia_id"]
            isOneToOne: false
            referencedRelation: "farmacias"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "estoque_medicamento_id_fkey"
      ...
      impressoes_farmacia: {
        ...
        Relationships: [
          {
            foreignKeyName: "impressoes_farmacia_consulta_id_fkey"
            columns: ["consulta_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "impressoes_farmacia_farmacia_id_fkey"
            columns: ["farmacia_id"]
            isOneToOne: false
            referencedRelation: "farmacias"
            referencedColumns: ["id"]
      ...
      suporte_mensagens: {
        ...
        Relationships: [
          {
            foreignKeyName: "suporte_mensagens_farmacia_id_fkey"
            columns: ["farmacia_id"]
            isOneToOne: false
            referencedRelation: "farmacias"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      registrar_consulta_com_localizacao:
        | {
            Args: {
              p_canal?: string
              p_latitude?: number
